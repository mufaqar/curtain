  ...
  // Get the custom field value
    ...
    if ($product->is_type('simple')) {
        ...
        echo '<div id="curtain_options" class="form-group curtain-options" style="display: block;">';
         ...
         echo '<input type="text" id="selectedMaterial_Label" name="selectedMaterial_Label" value="">';
         echo '<input type="text" id="selectedSize_Label" name="selectedSize_Label" value="">';
         echo '<input type="text" id="SizeValue" name="SizeValue" value="">';
